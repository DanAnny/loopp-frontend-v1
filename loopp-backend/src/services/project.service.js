...
import {
  ...
  // Import the shared strong resolver to avoid duplication
  resolveClientEmailStrong,
...
/* ----------------------- helper: (REMOVED) resolve client email -----------------------
   We now import resolveClientEmailStrong from email.service.js to avoid duplication.
---------------------------------------------------------------------------------------*/
